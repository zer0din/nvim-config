...
-- В качестве менеджера используется встроекнны vim.pack.

-- Автокоманда-хук для отслеживания обновлений плагинов.
-- Должна быть зарегистрированна ДО vim.pack.add. Чтоб сработать не только при
...
vim.api.nvim_create_autocmd('PackChanged', {
	...
	callback = function(ev)
		...
		-- nvim-treesitter.
		-- Перекомпилировать плагины, при обновлении.
